    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">Cliente desde {client.createdAt.toLocaleDateString('pt-BR')}</p>
        </div>
      ...
      <Tabs defaultValue="info" className="space-y-4">
        ...
        <TabsContent value="info" className="space-y-4">
          <div className="grid gap-4 md:grid-cols-2">
            <Card>
              ...
              <CardContent className="space-y-3">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <Badge variant="outline">{client.style}</Badge>
                </div>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardHeader>
                <CardTitle className="text-lg">Status e Tags</CardTitle>
              </CardHeader>
              <CardContent className="space-y-3">
                <div>
                  ...
                  {clientSessions.map((session) => (
                    <div key={session.id} className="flex items-center justify-between p-3 border rounded-lg">
                      ...
                      <div className="text-right">
                        <p className="font-medium">R$ {session.value.toLocaleString('pt-BR')}</p>
            ...
            <Card>
              ...
              <CardContent className="space-y-3">
                ...
                <div>
                  ...
                  <Badge className="ml-2" variant={totalPaid > 1000 ? 'default' : 'secondary'}>
