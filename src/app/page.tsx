...
function AppContent() {
  const { currentView, clients, sessions, transactions, goals, loading } = useApp();
...
function DashboardContent() {
  const { clients, sessions, transactions, goals } = useApp();
        ...
        <CardContent className="p-6">
          <div className="space-y-4">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">{user?.studio}</p>
            </div>
          </div>
        </CardContent>
      </Card>
